# Shiguang-Cover — Brand Guidelines
...
| Name | Hex | Usage |
|------|-----|-------|
| Primary | `#0EA5E9` | Gradient start, CTA, accents |
| Secondary | `#22C55E` | Gradient end, hover states |
| Text (light bg) | `#F8FAFC` | Body text on white/light |
| Text (dark bg) | `#0F172A` | Body text on dark |

...
![preview](https://img.shiguang666.eu.org/file/1781388708875_20260614061141477.webp)
...
| 🎨 **多图标库支持** | [LobeHub Icons](https://lobehub.com/icons) · [theSVG](https://thesvg.org) · [Developer Icons](https://xandemon.github.io/developer-icons/) · [Iconify](https://icon-sets.iconify.design/) · [HQ ICON](https://icon.shiguang666.eu.org/) |
| ⚡ **快捷前缀** | 支持 `lobe:`、`svg:`、`dev:` 等前缀快速切换图标源 |
| 🎯 **智能配色** | 纯色图标自动提取主色调作为背景色，标题/水印自动切换黑白对比色 |
| 🖼️ **图标背景形状** | 支持无背景、圆角背景、圆形背景三种样式 |
| 📏 **图标背景大小** | 独立滑块控制背景填充范围，不改变图标内容尺寸 |
| 📋 **预设管理** | 保存/加载/删除预设配置，快速切换不同封面样式 |
